...
def parse_argv():
	...
	target.add_argument('-compiler', choices=['vs2017', 'vs2019', 'clang9', 'gcc9', 'osx'], help='Defaults to the host system\'s default compiler')
	...
	parser.set_defaults(build=False, clean=False, compiler=None, config='Release', cpu='x64')
...
def set_compiler_env(compiler, args):
	if platform.system() == 'Linux':
		...
		os.environ['MAKEFLAGS'] = '-j{}'.format(num_threads)
		if compiler == 'clang9':
